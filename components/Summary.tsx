    ...
    <div className="space-y-6 pb-12">
      ...
      {!stats.hasAnyHadir ? (
        <div className="bg-white p-20 rounded-3xl shadow-sm border border-slate-200 text-center">
          ...
          <p className="text-sm text-slate-500 mt-2 max-w-sm mx-auto">Sila pastikan anda telah tanda kehadiran di <strong>Isi Kehadiran</strong> atau klik <strong>Tarik Data Cloud</strong> untuk memuat turun sejarah dari Google Sheets (Sila pilih julat tarikh yang betul).</p>
        </div>
      ) : (
